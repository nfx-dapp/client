...
export default function SearchPage() {
  ...
  return (
    <div className="p-page py-[15vh] flex flex-col">
      ...
      <div className="flex flex-wrap gap-y-6 mt-12 justify-between items-start min-h-screen">
        {filtered.map((item, key) => (
          <div
            key={key}
            className="flex flex-row justify-between hover:bg-white hover:bg-opacity-10 rounded-xl hover:cursor-pointer ease-in duration-200 hover:border-opacity-100 border border-primary border-opacity-0 p-[0.2rem] w-[48%]"
          >
