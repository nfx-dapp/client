          ...
          <div className="w-[30%] rounded-xl h-[30vh] flex flex-col items-center relative hover:cursor-pointer p-1 border border-primary group">
            ...
            <div className="bg-black border border-primary absolute -bottom-12 w-[90%] group-hover:scale-100 duration-300 ease-in scale-90  py-6 rounded-2xl px-6 flex flex-col gap-y-1">
              <div className="flex flex-row items-center justify-between">
                <div className="text-white text-[1.5rem] font-bold">{item.name}</div>
                <div className="text-[15px] truncate w-[40%] text-primary">@{item.owner}</div>
              </div>
